...
contentSlide({
  ...
  bestPractice: "משקיעים בהבנת התהליך של עבודה עם כלי אג'נטי — כמו **Claude Code** (כלי AI לכתיבת קוד מבית Anthropic), **Cursor** (עורך קוד עם AI מובנה) או Gemini CLI — לא רק ב\"איך לוחצים איפה\" בכלי ספציפי אחד.",
...
contentSlide({
  ...
  bullets: [
    ...
    "בלי Backend — מספיק קובץ HTML/CSS/JS אחד שרץ בדפדפן, עם שמירה ב-**localStorage** (זיכרון מקומי בדפדפן שנשמר גם אחרי רענון הדף)",
  ],
