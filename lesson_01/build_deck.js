...
contentSlide({
  ...
  bullets: [
    ...
    "לא \"מבין\" כמו בן אדם — מנבא **Token** (יחידת טקסט קטנה: מילה או חלק ממילה) אחר Token מה סביר לבוא בהמשך",
...
milestoneSlide({
  ...
  bullets: [
    ...
    "סימון משימה כהושלמה",
    "מחיקת משימה",
    "שמירה עם localStorage (זיכרון מקומי בדפדפן שנשמר גם אחרי רענון הדף)",
  ],
